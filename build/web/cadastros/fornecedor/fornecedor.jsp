            ...
            <table id="datatable" class="display">
                <thead>
                    <tr>
                        ...
                        <th align="center">Obeservação</th>
                ...
                <tbody>
                    <c:forEach var="fornecedor" items="${fornecedors}">                    
                        <tr>
...
<script>
    ...
    function setDadosModal(valor) {
        ...
        if (idCli != "0"){
            ...
            $.getJSON('FornecedorCarregar', {idFornecedor: idCli}, function(respostaServlet){
    ...
    function carregarPessoa(v) {
        ...
        $(document).ready(function () {
            $.getJSON('PessoaBuscarCpfCnpj', {cpfcnpjpessoa: idM, tipopessoa: tipoPessoa}, function (respostaCli) {
                ...
                //var id = respostaCli.idFornecedor;
                if (respostaCli != null)
                {
                    $('#idfornecedor').val(respostaCli.idFornecedor);
                    $('#permitelogin').val(respostaCli.permiteLogin);
                    $('#situacao').val(respostaCli.situacao);
                    $('#enderecoweb').val(respostaCli.enderecoweb);
    ...
    function validarCampos() {
        ...
        if (document.getElementById("enderecoweb").value == '') {
            Swal.fire({
                position: 'center',
                icon: 'error',
                title: 'Verifique a Observação do Fornecedor!',
                showConfirmButton: true,
                timer: 2000
            });
            $("enderecoweb").focus();
