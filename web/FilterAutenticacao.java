...
public class FilterAutenticacao implements Filter {
    ...
    @Override
    public void init(FilterConfig filterConfig) throws ServletException { //SISTEMA RODADO NO SERVIDOR, TUDO PROGRAMADO EXCUTA
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) 
            throws IOException, ServletException { //SERVE COMO UM FUNIL 
         try{
    ...
    @Override
    public void destroy() { //QUANDO VC PARA DE EXCLUTAR 
        try {
            conexao.close();
